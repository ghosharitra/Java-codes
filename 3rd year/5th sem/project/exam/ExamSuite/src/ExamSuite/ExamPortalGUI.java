 ...
 * @author arpan
 */
public class ExamPortalGUI extends javax.swing.JFrame {
     ...
     */
    public ExamPortalGUI() {
        initComponents();
    }
    public ExamPortalGUI(String id) {
        initComponents();
        this.id=id;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/student", "root", "0801");
            ...
            pstmt.executeUpdate();
            JOptionPane.showMessageDialog(null, "exam started","msg", JOptionPane.PLAIN_MESSAGE);
            conn.close();
            }
        catch(Exception e){
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            Connection conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/", "root", "0801");
            PreparedStatement pstmt= conn.prepareStatement(sql);
            ...
            System.out.println(e);
        */
            (new JavaGUI(id)).setVisible(true);
            this.dispose();
        }
        ...
        */
            (new PythonGUI(id)).setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExamPortalGUI().setVisible(true);
            }
        });
    }
